        ...
        <VCard>
          ...
          <VCardText class="d-flex flex-wrap justify-space-between flex-column flex-sm-row print-row">
            ...
            <div class="ma-sm-4">
              ...
              <!-- 👉 Address -->
              <p class="mb-0">
                Địa chỉ : Trường ĐHCN Hà Nội, Nhổn - Từ Liêm
              </p>
              <p class="mb-0">
                Tên shop: HoangTube
              </p>
            ...
            <div class="mt-4 ma-sm-4">
              ...
              <h6 class="font-weight-medium text-xl mb-6">
                Hóa đơn số #{{ orderData.id }}
              </h6>

              <!-- 👉 Issue Date -->
              <p class="mb-2">
                <span>Ngày tạo: </span>
                <span class="font-weight-semibold">{{ dayjs(orderData.updatedAt).format('DD/MM/YYYY HH:mm:ss') }}</span>
              </p>
          ...
          <VTable>
            ...
            <tbody>
              <tr
                ...
                :key="item.name"
              >
                <td class="text-no-wrap" v-if="item.size == 99">
                  {{ item.product.name }} - ( Freesize )
                </td>
              ...
              <table>
                <tr>
                  ...
                  <td class="font-weight-semibold">
                    ...
                    <p class="mb-2">
                      {{ (priceTotal - orderData.discount).toLocaleString('it-IT', {style : 'currency', currency : 'VND'}) }}
                    </p>
                  </td>
                </tr>
              </table>
